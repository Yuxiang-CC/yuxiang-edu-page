<template>
    ...
    <table class="GoodList">
      <tbody>
        <tr>
          <td colspan="3" class="teacher" style="padding: 20px 0px 20px 30px;">讲师：{{ order.teacherName }}</td>
        </tr>
        <tr class="good">
          <td class="name First">
    ...
    <div class="Finish">
      <div class="check fr">
        <el-checkbox v-model="agree">我已阅读并同意<a href="javascript:" target="_blank">《雨巷学院购买协议》</a></el-checkbox>
      </div>
      <div class="clear"/>
      <div class="Main fl">
        <div class="fl">
 ...
 data() {
  ...
  methods: {
    toPay() {
      ...
      console.log("courseID:" , this.order.orderNo)
      payApi.aliPay(this.order.orderNo).then(res => {
        this.paying = true
        console.log("即将跳转URL")
        console.log(res)
        // 跳转到支付页面
